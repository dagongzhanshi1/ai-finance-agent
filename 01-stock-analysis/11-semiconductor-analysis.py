...
输出：output/semiconductor_nav.png、output/semiconductor_heatmap.png
"""
import pandas as pd
...
# 1. 下载数据
# =============================================
symbols = ["688981.SS", "002371.SZ", "603501.SS", "688012.SS"]
names = ["中芯国际", "北方华创", "韦尔股份", "中微公司"]
...
for i, name in enumerate(names):
    ...
    ax.annotate(f"{dd:.1%}", 
                ...
                fontsize=9,
                color=colors[i],
                arrowprops=dict(arrowstyle="->", color=colors[i], alpha=0.8))
...
plt.tight_layout()
nav_curve_path = output_dir / "semiconductor_nav.png"
...
plt.tight_layout()
heatmap_path = output_dir / "semiconductor_heatmap.png"
